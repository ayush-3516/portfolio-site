...
export default async function HomePage() {
  ...
  return (
    <div>
      {/* HERO */}
      <section className="section-wide hero-grid" style={{ paddingTop: 96, paddingBottom: 60 }}>
        <div style={{ animation: 'rise .6s ease both' }}>
          ...
          <h1 className="hero-h1" style={{ fontFamily: "'Inter Tight', sans-serif", fontWeight: 800, lineHeight: 1.04, letterSpacing: '-0.03em', color: 'var(--ink)', marginBottom: 22 }}>
      ...
      {/* AUDIENCE SWITCHER */}
      <section className="section-wide" style={{ paddingTop: 30, paddingBottom: 50 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 18, flexWrap: 'wrap', padding: '24px 28px', borderRadius: 18, background: 'var(--surface)', border: '1px solid var(--border)' }}>
          <div style={{ fontFamily: "'Inter Tight', sans-serif", fontWeight: 600, fontSize: 16, color: 'var(--ink)', width: '100%' }}>I'm hiring for…</div>
          {[
            ...
            <Link key={card.href} href={card.href} style={{ flex: 1, minWidth: 160, padding: '16px 18px', borderRadius: 13, border: '1px solid var(--border)', background: 'var(--surface-2)', textDecoration: 'none', display: 'block' }}>
      ...
      <section style={{ borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)', background: 'var(--surface)' }}>
        <div className="section-wide proof-grid" style={{ paddingTop: 42, paddingBottom: 42 }}>
          {[
      ...
      {/* FEATURED WORK */}
      <section className="section-wide" style={{ paddingTop: 70, paddingBottom: 40 }}>
      ...
      {/* STACK */}
      <section className="section-wide" style={{ paddingTop: 50, paddingBottom: 50 }}>
      ...
      <section className="section-wide" style={{ paddingTop: 50, paddingBottom: 50 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          {(timelineGlobal?.entries ?? []).map((t: any, i: number) => (
            <div key={i} className="timeline-row" style={{ padding: '24px 0', borderTop: '1px solid var(--border)' }}>
      ...
      {/* PHILOSOPHY + CTA */}
      <section className="section-wide" style={{ paddingTop: 50, paddingBottom: 40 }}>
        <div className="cta-pad" style={{ borderRadius: 22, background: 'linear-gradient(150deg, var(--accent-soft), var(--surface))', border: '1px solid var(--border)' }}>
